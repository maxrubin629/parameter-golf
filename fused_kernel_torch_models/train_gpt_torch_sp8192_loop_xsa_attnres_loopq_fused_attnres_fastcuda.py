#!/usr/bin/env python3
"""
CUDA/PyTorch conversion of train_gpt_mlx_sp8192_loop_xsa_attnres_loopq_fastmlx.py.
...
ARCH_KIND = "looped"
ARCH_NAME_DEFAULT = "sp8192_loop_xsa_attnres_loopq_fused_attnres"
...
class BlockDepthMixer(nn.Module):
    ...
    def forward(self, sources: list[Tensor], loop_idx: int = 0) -> Tensor:
        ...
        nsrc = len(sources)
        if self.fused:
            keys = [rms_norm(src) for src in sources]
